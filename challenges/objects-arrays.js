...
const unisWithUni = [] = graduates.filter(graduate => (graduate.university.indexOf("Uni") >= 0));
console.log(unisWithUni);


// ==== ADVANCED Array Methods ====

// Given this zoo data from around the United States, foellow the instructions below.  Use the specific array methods in the requests below to solve the problems.
